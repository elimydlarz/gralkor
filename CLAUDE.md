...
- `falkordblite` is not compatible with Python 3.14 (the module fails to load). The server dev environment pins Python 3.13 via `server/.python-version`. The runtime server manager tries Python 3.12–3.13 candidates first.
