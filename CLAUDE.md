...
| auto-recall | `before_prompt_build` searches graph facts + native Markdown in parallel, injects combined results plus behavioral instruction encouraging 2-3 parallel manual searches per turn. Fires once per turn. |
